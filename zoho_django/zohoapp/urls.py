...
# 	path('comment/<int:id>', views.comment, name='comment'),
    ...
    path('profit_and_loss_scedule_iii_edits_accounts_mapping',views.profit_and_loss_scedule_iii_edits_accounts_mapping,name='profit_and_loss_scedule_iii_edits_accounts_mapping'),
